...
public class KeycloakSecurityConfig extends KeycloakWebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .and()
                .addFilterBefore(basicAuthFilter(), KeycloakAuthenticationProcessingFilter.class)
                .formLogin().disable();
    }
    ...
    public BasicAuthFilter basicAuthFilter() {
        BasicAuthFilter basicAuthFilter = new BasicAuthFilter(applicationContext, basicEndPoint);
